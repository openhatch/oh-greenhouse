...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Activity', fields ['version', 'package']
        db.delete_unique(u'greenhouse_activity', ['version', 'package'])

        # Deleting field 'Activity.version'
        db.delete_column(u'greenhouse_activity', 'version')

        # Deleting field 'Activity.package'
        db.delete_column(u'greenhouse_activity', 'package')


    def backwards(self, orm):
        # Adding field 'Activity.version'
        db.add_column(u'greenhouse_activity', 'version',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Activity.package'
        db.add_column(u'greenhouse_activity', 'package',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Activity', fields ['version', 'package']
        db.create_unique(u'greenhouse_activity', ['version', 'package'])
