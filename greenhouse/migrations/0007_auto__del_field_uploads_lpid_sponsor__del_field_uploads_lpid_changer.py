...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Uploads.lpid_sponsor'
        db.delete_column(u'uploads', 'lpid_sponsor')

        # Deleting field 'Uploads.lpid_changer'
        db.delete_column(u'uploads', 'lpid_changer')


    def backwards(self, orm):
        # Adding field 'Uploads.lpid_sponsor'
        db.add_column(u'uploads', 'lpid_sponsor',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Uploads.lpid_changer'
        db.add_column(u'uploads', 'lpid_changer',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
