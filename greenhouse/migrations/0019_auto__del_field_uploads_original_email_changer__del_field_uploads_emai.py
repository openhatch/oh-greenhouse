...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Uploads.original_email_changer'
        db.delete_column(u'greenhouse_uploads', 'original_email_changer')

        # Deleting field 'Uploads.email_changer'
        db.delete_column(u'greenhouse_uploads', 'email_changer')


    def backwards(self, orm):
        # Adding field 'Uploads.original_email_changer'
        db.add_column(u'greenhouse_uploads', 'original_email_changer',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Uploads.email_changer'
        db.add_column(u'greenhouse_uploads', 'email_changer',
                      self.gf('django.db.models.fields.EmailField')(blank=True, default='', max_length=75, db_index=True),
                      keep_default=False)
