...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'uploads', 'original_email_changer')

        # Deleting field 'People.original_email'
        db.delete_column(u'people', 'original_email')
