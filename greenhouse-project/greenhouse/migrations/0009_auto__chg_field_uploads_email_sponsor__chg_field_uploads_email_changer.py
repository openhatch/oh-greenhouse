...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Uploads.email_sponsor'
        db.alter_column(u'uploads', 'email_sponsor', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'Uploads.email_changer'
        db.alter_column(u'uploads', 'email_changer', self.gf('django.db.models.fields.EmailField')(max_length=75))

        # Changing field 'People.email'
        db.alter_column(u'people', 'email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75))

    def backwards(self, orm):

        # Changing field 'Uploads.email_sponsor'
        db.alter_column(u'uploads', 'email_sponsor', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Uploads.email_changer'
        db.alter_column(u'uploads', 'email_changer', self.gf('django.db.models.fields.TextField')())

        # Changing field 'People.email'
        db.alter_column(u'people', 'email', self.gf('django.db.models.fields.TextField')(unique=True))
