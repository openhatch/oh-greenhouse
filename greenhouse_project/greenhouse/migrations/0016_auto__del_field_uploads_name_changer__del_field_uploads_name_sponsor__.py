...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Uploads.name_changer'
        db.delete_column(u'greenhouse_uploads', 'name_changer')

        # Deleting field 'Uploads.name_sponsor'
        db.delete_column(u'greenhouse_uploads', 'name_sponsor')

        # Deleting field 'Uploads.email_sponsor'
        db.delete_column(u'greenhouse_uploads', 'email_sponsor')

        # Deleting field 'Uploads.release'
        db.delete_column(u'greenhouse_uploads', 'release')


    def backwards(self, orm):
        # Adding field 'Uploads.name_changer'
        db.add_column(u'greenhouse_uploads', 'name_changer',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Uploads.name_sponsor'
        db.add_column(u'greenhouse_uploads', 'name_sponsor',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Uploads.email_sponsor'
        db.add_column(u'greenhouse_uploads', 'email_sponsor',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Uploads.release'
        db.add_column(u'greenhouse_uploads', 'release',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
