...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Uploads.type'
        db.add_column(u'greenhouse_uploads', 'type',
                      self.gf('django.db.models.fields.CharField')(default='upload', max_length=128),
                      keep_default=False)

        # Adding field 'Uploads.subproject'
        db.add_column(u'greenhouse_uploads', 'subproject',
                      self.gf('django.db.models.fields.CharField')(default='debian', max_length=128),
                      keep_default=False)

        # Adding field 'Uploads.original_person'
        db.add_column(u'greenhouse_uploads', 'original_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['greenhouse.People']),
                      keep_default=False)

        # Adding field 'Uploads.person'
        db.add_column(u'greenhouse_uploads', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['greenhouse.People']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Uploads.type'
        db.delete_column(u'greenhouse_uploads', 'type')

        # Deleting field 'Uploads.subproject'
        db.delete_column(u'greenhouse_uploads', 'subproject')

        # Deleting field 'Uploads.original_person'
        db.delete_column(u'greenhouse_uploads', 'original_person_id')

        # Deleting field 'Uploads.person'
        db.delete_column(u'greenhouse_uploads', 'person_id')
