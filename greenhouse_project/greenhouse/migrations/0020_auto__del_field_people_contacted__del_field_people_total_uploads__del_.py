...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'People.total_uploads'
        db.delete_column(u'greenhouse_people', 'total_uploads')

        # Deleting field 'People.first_upload'
        db.delete_column(u'greenhouse_people', 'first_upload_id')

        # Deleting field 'People.last_upload'
        db.delete_column(u'greenhouse_people', 'last_upload_id')


    def backwards(self, orm):
        # Adding field 'People.contacted'
        db.add_column(u'greenhouse_people', 'contacted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'People.total_uploads'
        db.add_column(u'greenhouse_people', 'total_uploads',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'People.first_upload'
        raise RuntimeError("Cannot reverse this migration. 'People.first_upload' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'People.last_upload'
        raise RuntimeError("Cannot reverse this migration. 'People.last_upload' and its values cannot be restored.")
